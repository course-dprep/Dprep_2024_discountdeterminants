...
###### Objective ########
#########################
# Input: Table from first stage analysis
# Output: Second-stage Regression output


df <- fread("../../gen/firststage/df_firststage.csv")
...
dir.create('../../gen/secondstage')
saveRDS(fixedSecondStageLS, "../../gen/secondstage/secondstage_ls.rds")
