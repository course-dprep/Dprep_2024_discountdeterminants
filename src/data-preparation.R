...
#########################
# Input: scanner data
# Output: Aggregate data ready for first-stage analysis (estimate discoutns elasticity)
...
###########################
  ...
  write.csv(df_bybrand_formats,'../gen/data-preparation/df_aggregate.csv')
  write.csv(categorycharacteristic,'../gen/data-preparation/categorycharacteristic.csv')
  write.csv(brandcharacteristic,'../gen/data-preparation/brandcharacteristic.csv')
  rm(list = ls())
  gc()
